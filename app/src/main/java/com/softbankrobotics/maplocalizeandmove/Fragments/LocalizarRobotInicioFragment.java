...
public class LocalizarRobotInicioFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        LocalizarRobotInicioFragment currentFragment = (LocalizarRobotInicioFragment) ma.getFragment();
        Button back_button = view.findViewById(R.id.back_button);
        back_button.setOnClickListener((v) -> {
            ma.stopLocalizing();
            ma.setFragment(new PantallaInicioFragment(), true);
