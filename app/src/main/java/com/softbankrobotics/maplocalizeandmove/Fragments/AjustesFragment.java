...
public class AjustesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        int fragmentId = R.layout.fragment_ajustes;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        view.findViewById(R.id.button_setup_mode).setOnClickListener(
                (v) -> ma.setFragment(new ConfiguracionFragment(), false));
        view.findViewById(R.id.button_production_mode).setOnClickListener(
                (v) -> ma.setFragment(new PruebasFragment(), false));
        view.findViewById(R.id.button_back).setOnClickListener(
                (v) -> ma.setFragment(new PantallaInicioFragment(), false));
    }
